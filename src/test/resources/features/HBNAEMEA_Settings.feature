...
And user should be displayed with "Filter reminder" message on "Activity History" history screen
Examples:
|Replace filter value as month|
|1 month|
|2 month|
|3 month|
|4 month|
...
@SetupHomekitAndSiriiOS
 Scenario: As a user i should be able to set homekit and siri using Custom location.
 Given user launches and logs in to the Lyric application 
 ...
 And user should be displayed with the "Add accessory" Screen
 When user clicks on " Don't Have a code or can't Scan" option
 Then user should be displayed with the "manual code" Screen
 When user clicks on "Enter code" Option
 Then user should be displayed with the " Enter Homekit Setup" Screen
 When user inputs the " Homekit Code"
 Then user should be displayed with the " Add accessory" Screen
 ...
 #JasperNA, JasperEMEA, HB_Spruce
 @SetupHomekitAndSiriiOS
 Scenario: As a user i should be able to set homekit and siri using default location.
 Given user launches and logs in to the Lyric application 
 When user navigates to "Setup Homekit & Siri" screen from the "Dashboard" screen 
 Then user should be displayed with the "Looking for Device" Spinner
 And user should be displayed with the "Identify Thermostat" Spinner
 ...
 Then user should be displayed with the " Add accessory" Screen
 And user should be displayed with the "Thermostat Room" Screen
 When user inputs <defualt Location>
 Then user should be displayed with the " Thermostat Configuration" Screen
 And user should be displayed with the "Identify" Option 
...
Scenario: As a user I should not be able view Auto changeover when heatonly or coolonly enabled on my thermostat
Given user launches and logs in to the Lyric application
When user navigates to "Thermostat Settings" screen from the "Dashboard" screen
...
Scenario: As a user I should not be able view Auto changeover when coolonly enabled on my thermostat
Given user launches and logs in to the Lyric application
When user navigates to "Thermostat Settings" screen from the "Dashboard" screen
...
Scenario: As a user I should not be able view Auto changeover when Heatonly enabled on my thermostat
Given user launches and logs in to the Lyric application
When user navigates to "Thermostat Settings" screen from the "Dashboard" screen
...
When adds a <Network Type> WiFi network with WiFi SSID as <WiFi SSID> and WiFi Password as <WiFi Password>
