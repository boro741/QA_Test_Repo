...
@VerifyWLDSettings @Automated @ATER-53786
...
@EnableDisableIndoorTemperatureAlertInWLDSettings @Automated @ATER-53787
...
@EnableDisableEmailNotifications @NotAutomatable @ATER-53851
...
@WLDChangeAlertForThisRangeforTemperature @AutomatedforAndroidOnly @ATER-53852
...
@EnableDisableIndoorHumidityAlert  @Automated @ATER-53853
...
@EnableDisableEmailForEnabledAlertsforHumidity @NotAutomatable @ATER-53854
...
@ChangeAlertForThisRangeforHumididty @AutomatedforAndroidOnly @ATER-53855
Scenario: As a user I should be able to change Alert For This Range on my WLD
Given user launches and logs in to the Lyric application
When user navigates to "WLD Manage Alerts" screen from the "Dashboard" screen
And user changes the "WLD Indoor Humidity Alert" to "ON"
...
@SetEmailContacts @Automated @ATER-53856
...
@ChangeTemperatureUnit @Automated @ATER-53857
...
@SetUpdateFrequency @Automated @ATER-53858
...
@RenameWLDdevice  @Automated @ATER-53859
...
@RenameWLDWithDuplicatename @Automatedwithtwowlds @ATER-53860
...
@ViewLeakDetectorconfigurationOptions @Automated @ATER-53861
...
@DeleteLeakDetector @NotAutomatable @ATER-53862
...
@DeleteLeakDetectorwhenDeviceOffline @NotAutomatable @CogIconNotVissible @ATER-53863
Scenario: As a user I should be able to delete my WLD device from my account through the Homes application 
Given user launches and logs in to the Homes application 
When user navigates to "Leak Detector Configuration" screen from the "Dashboard" screen
And user "Deletes Leak Detector" by clicking on "Delete" button
