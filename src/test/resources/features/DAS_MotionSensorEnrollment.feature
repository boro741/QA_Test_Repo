...
Scenario Outline: As a user I should be able to successfully enroll Motion Viewer with custom sensor name
Given user launches and logs in to the Lyric application
#And user is set to <Mode> through CHIL
...
#Then user <Sensor Name> <Motion Status>
Then user should see the "MOTION SENSOR" status as <Motion Status> on the "Test Access Sensor"
#And user <Sensor Name> <Motion Status Update>
...
And user selects "delete sensor" from "Motion Sensor settings" screen
Then user should receive a "Delete Sensor Confirmation" popup
And user "dismisses" the "Delete Sensor Confirmation" popup
...
@DASMotionViewerEnrollmentWithSensorNotWorkingAndIsWithInRange
Scenario Outline: As a user I should be able to successfully enroll Motion Viewer when sensor is not working but is within range
Given user launches and logs in to the Lyric application
...
#####When user selects "Get Additional Help" "Motion Sensor Help" screen
...
And user should see the "motion sensor" status as <Signal strength> on the "Signal Strength" screen
