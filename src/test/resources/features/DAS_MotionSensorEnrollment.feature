...
@DASMotionViewerEnrollmentWithDefaultSensorName
Scenario Outline: As a user I should be able to successfully enrol Motion Viewer with default name
...
user selects "SETUP button" from "Set Up Accessories" screen
Then user should be displayed with the "Locate Sensor" Screen
Then user navigates to "Name Sensor" screen from the "Locate Sensor" screen
When user navigates to "Custom Name Sensor" screen from the "Name Sensor" screen
And user inputs <Custom name> in the "Custom Name Sensor" screen
...
|Home | Front Hall  | Flat on a Wall     | Mount on the Wall |Medium |NO MOTION DETECTED |MOTION DETECTED |
|Home | Front Hall  | Flat on a Wall     | Mount on the Wall |Low |NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |  In a Wall Corner | Mount in a Corner |High | NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |  In a Wall Corner | Mount in a Corner |Medium | NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |  In a Wall Corner | Mount in a Corner |Low | NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |   Flat on a Wall     | Mount on the Wall |High|NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |   Flat on a Wall     | Mount on the Wall |Medium|NO MOTION DETECTED |MOTION DETECTED |
|Home | Back Hall |   Flat on a Wall     | Mount on the Wall |Low |NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room |  In a Wall Corner | Mount in a Corner |High| NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room |  In a Wall Corner | Mount in a Corner |Medium| NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room |  In a Wall Corner | Mount in a Corner |Low| NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room  |   Flat on a Wall     | Mount on the Wall |High|NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room  |   Flat on a Wall     | Mount on the Wall |Medium|NO MOTION DETECTED |MOTION DETECTED |
|Home | Living Room  |   Flat on a Wall     | Mount on the Wall |Low|NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall |  In a Wall Corner | Mount in a Corner | High |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall |  In a Wall Corner | Mount in a Corner | Medium |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall |  In a Wall Corner | Mount in a Corner | Low | NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall  | Flat on a Wall     | Mount on the Wall |High |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall  | Flat on a Wall     | Mount on the Wall |Medium |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Front Hall  | Flat on a Wall     | Mount on the Wall |Low |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |  In a Wall Corner | Mount in a Corner |High | NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |  In a Wall Corner | Mount in a Corner |Medium | NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |  In a Wall Corner | Mount in a Corner |Low | NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |   Flat on a Wall     | Mount on the Wall |High|NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |   Flat on a Wall     | Mount on the Wall |Medium|NO MOTION DETECTED |MOTION DETECTED |
|OFF | Back Hall |   Flat on a Wall     | Mount on the Wall |Low |NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room |  In a Wall Corner | Mount in a Corner |High| NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room |  In a Wall Corner | Mount in a Corner |Medium| NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room |  In a Wall Corner | Mount in a Corner |Low| NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room  |   Flat on a Wall     | Mount on the Wall |High|NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room  |   Flat on a Wall     | Mount on the Wall |Medium|NO MOTION DETECTED |MOTION DETECTED |
|OFF | Living Room  |   Flat on a Wall     | Mount on the Wall |Low|NO MOTION DETECTED |MOTION DETECTED |
...
@DASMotionViewerEnrollmentflowtimeoutpopupVerification
Scenario Outline : verify push notification while Access Sensor Enrolment
Given user launches and logs in to the Lyric application
And user is set to <Mode> through CHIL
When user navigates to "Sensors" screen from the "Dashboard" screen
