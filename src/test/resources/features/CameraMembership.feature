...
@Membersip_StandardMonthly_FromHoneywellMembershipScreen     @P1    @AutomatedOnAndroid
...
@Membersip_StandardAnnaul_FromHoneywellMembershipScreen    @P1     @AutomatedOnAndroid
...
@Membersip_PremiumMonthly_FromHoneywellMembershipScreen    @P1     @AutomatedOnAndroid
...
@Membersip_PremiumAnnaul_FromHoneywellMembershipScreen    @P1      @AutomatedOnAndroid
...
@Cancellation_ActiveSubscription	     @P1  @AutomatedOnAndroid
...
@Cancellation_ActiveSubscription_FreeTrial	@P1   @AutomatedOnAndroid
Scenario: As a user I should be able to cancel my active subscription
		Given "add" camera from CHIL
		And user launches and logs in to the Lyric application
		When user navigates to "Honeywell Membership" screen from the "dashboard" screen
