...
#  
 ...
 When user turns "off" vacation from "vacation settings card"
...
When user turns "off" vacation from "solution card"
 Then user gets cautioned with guide message about vacation turned off for the location
...
#  Scenario Outline: As a user I want to set the vacation set value so that I can put my home with desired temperature on my vacation  
#    Given vacation mode is "InActive"
#    And user launches and logs in to the Lyric application
#    And user navigates to "Vacation" screen from the "Dashboard" screen
#    When user turns "on" vacation from "vacation settings card"
...
#  Scenario Outline: As a user I want to verify that HBB stats are not present in vacation comfort settings 
...
#     And user logs out of the app
##  
#  @Vacation_TimerValueIncreamentOf15EMEA 
#  Scenario: As a user I want to verify the minimum Bandwidth Limit for vacation from and To 
...
#      And user logs out of the app
##
#       @Vacation_TimerValueIncreamentOf10NA 
#  Scenario: As a user I want to verify the minimum Bandwidth Limit for vacation from and To 
#     When acation mode is "Active"
#      And user launches and logs in to the Lyric application
#      And user navigates to "Vacation" screen from the "Dashboard" screen
...
#     And user logs out of the app
#  
#  @Vacation_Enable/DisbaleIndividulaStat 
...
#When user turns "on" vacation from "vacation settings card"
#Then user should be displayed with  "Vacation" status on "SolutionCard" 
#When user change the "OFF" from <Mode>
#Then user should be displayed with "SYSTEM IS OFF" status on "SolutionCard" 
...
#Given user launches and logs in to the Lyric application
#Then user has "Heat" system mode
#When user turns "on" vacation from "vacation settings card"
#Then user should be displayed with  "Vacation" status on "SolutionCard" 
#When user change the "OFF" from <Mode>
#Then user should be displayed with "SYSTEM IS OFF" status on "SolutionCard"
...
#Given user launches and logs in to the Lyric application
#Then user has <Mode> system mode
#And user thermostat is set to "Geofence" schedule
#When user navigates to "Solutioncard" screen from "Dashboard" screen
#And user edits set point from "Primary Card"
#Then user should be displayed with <AdhocOverride> on "SolutionCard"
#When vacation mode is "active"
#Then user should be displayed with "Vacation" status on "SolutionCard"
#When user navigates to "Dashboard" screen from "Solutioncard" screen
#And user navigates to "Vacation" screen from the "Dashboard" screen
#And user turns "off" vacation from "vacation settings card" 
#Then user should be display with <UAdhocOverride> on "SolutionCard"
#Examples:
#|Mode | AdhocOverride | UAdhocOverride | 
...
##  Scenario Outline: Verify if vacation is active when user is in Dashboard
##    Given vacation mode is Active
