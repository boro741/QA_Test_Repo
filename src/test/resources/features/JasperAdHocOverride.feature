...
so that my stat will follow vacation setting on my absence in my home during the vacation days  
  ...
  @AdhocOverrideScheduleTemperature1 @FlyAutomated @--xrayid:ATER-7386
  ...
  @AdhocOverrideScheduleTemperatureGeofenceschedulingChangemodeHeatcool @FlyAutomated @--xrayid:ATER-7388
  ...
  @AdhocOverrideScheduleTemperatureGeofenceschedulingResume1 @FlyAutomated @--xrayid:ATER-7389
...
Examples: 
  ...
  @AdhocOverrideScheduleTemperatureTimeschedulingChangemodeHeatcool @FlyAutomated @--xrayid:ATER-7391
  ...
  @AdhocOverrideScheduleTemperatureTimeschedulingPermanently @FlyAutomated @--xrayid:ATER-7392
  ...
  @AdhocOverrideScheduleTemperatureTimeschedulingHolduntil @FlyAutomated @--xrayid:ATER-7394
  ...
  @AdhocOverrideScheduleTemperatureTimeschedulingResumeAfterPermanentHold @FlyAutomated @--xrayid:ATER-7396
  ...
  @AdhocOverrideScheduleTemperatureTimeschedulingResumeAfterHoldUntil @FlyAutomated @--xrayid:ATER-7398
  Scenario: Resume scheduling from override from Time Scheduling
    Given user thermostat is set to "time Based" schedule
      And user launches and logs in to the Lyric application
      And user selects "Jasper device" from the dashboard
  ...
  @OverrideTemperatureStatoffmode @FlyAutomated @--xrayid:ATER-7400
  ...
  @VerifyVacationStatusOnDevicecard @FlyAutomated @--xrayid:ATER-7402
