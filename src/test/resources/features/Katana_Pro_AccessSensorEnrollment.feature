...
Scenario Outline: As a user I should be able to successfully enrol RF6 Access Sensor with custom sensor name and video should play for assistance in sensor enrolment
...
Scenario Outline: As a user I should be able to successfully enrol RF6 MiniCT Access Sensor with custom sensor name and video should play for assistance in sensor enrolment
Given reset relay as precondition
And user launches and logs in to the Lyric application
And user is set to <Mode> mode through CHIL
When user navigates to "Add New Device Dashboard" screen from the "Dashboard" screen
