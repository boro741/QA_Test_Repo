...
@CreateEMEAEverydayscheduleSinglestatDefaultvalue  @FlyAutomated @--xrayid:ATER-7431
...
#      | geofence based |
  ...
  @CreateEMEAWeekdayandWeekendTimebasedscheduleSinglestatDefaultvalue @FlyAutomated @--xrayid:ATER-7432
  ...
  @CautionmessageTochangeGeofencescheduleFromWeekdayandWeekendscheduleCancels  @FlyAutomated @--xrayid:ATER-7433
  ...
  @CautionmessageTochangeGeofencescheduleFromWeekdayandWeekendscheduleConfirms @FlyAutomated  @--xrayid:ATER-7434
  ...
  @CautionmessageTochangeGeofencescheduleFromEverydayscheduleCancels @FlyAutomated  @--xrayid:ATER-7435
  ...
  @CautionmessageTochangeGeofencescheduleFromEverydayscheduleConfirms  @FlyAutomated @--xrayid:ATER-7436
  ...
  @CreateEMEAEverydayscheduleTemperatureRange  @FlyAutomated @--xrayid:ATER-7437
  ...
  @CreateEMEAWeekdayandWeekendscheduleTemperatureRange @FlyAutomated @--xrayid:ATER-7438
  ...
  @CreateEMEAEverydayscheduleTimeformat @FlyAutomated @--xrayid:ATER-7439
  ...
  @CreateEMEAEverydayscheduleAddingperiod @FlyAutomated @--xrayid:ATER-7440
  ...
  I want to create Everyday schedule by adding new period for both time format
    ...
    And user selects "Jasper device" from the dashboard
     ...
     Then verify "everyday" schedule gets created successfully
      And user logs out of the app
#  
  @CreateEMEAEverydayscheduleDeletingperiod @FlyAutomated @--xrayid:ATER-7441
  Scenario: To create EMEA Everyday schedule by setting up with new time value for both time format
  As an user
  ...
  @CreateEMEAWeekedayandWeekendscheduleAddingperiod @FlyAutomated @--xrayid:ATER-7442
  ...
  @CreateEMEAWeekedayandWeekendscheduleDeletingperiod @FlyAutomated @--xrayid:ATER-7443
  Scenario: To create EMEA Weekeday and Weekend schedule by setting up with new time value for time format 12hr
  As an user
  ...
  @CreateEMEAWeekdayandWeekendScheduleTimeformat @FlyAutomated @--xrayid:ATER-7444
  ...
  @CreateEMEAEverydayscheduleMultistatCopyschedule @FlyAutomated @--xrayid:ATER-7445
  ...
  @CreateEMEAWeekdayandWeekendscheduleMultistatCopyschedule @FlyAutomated @--xrayid:ATER-7446
