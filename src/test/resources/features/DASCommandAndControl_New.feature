...
@CommandControlWhenISMVIsInFault		@UIAutomated
Scenario Outline: As a user I want to switch to different states in my DAS device when there is a ISMV at fault 
Given user sets the entry/exit timer to "30" seconds
When user launches and logs in to the Lyric application
And user is set to "Home" mode through CHIL
When user navigates to "Security Solution Card" screen from the "Dashboard" screen
And user ISMV <Fault Type>
When user navigates to "Sensor Status" screen from the "Security Solution Card" screen
Then user should see the <Sensor Type> status as <Sensor Issue Type> on the "Sensor Status"
When user switches from "Home" to "Away"
Then user should receive a "Switch to Away" popup
...
When user navigates to "Sensor Status" screen from the "Security Solution Card" screen
Then user should see the <Sensor Type> status as <Sensor Issue Type> on the "Sensor Status"
Then user ISMV <Update Fault Type>

Examples:
|	Sensor Type		|	Fault Type			|	Sensor Issue Type		|	Off Status		|	Update Fault Type	|
|	ISMV	|	tampered				|	cover tampered			|	off				|	Tamper Restored		|

@CommandControlWhenOSMVIsInFault		@UIAutomated
Scenario Outline: As a user I want to switch to different states in my DAS device when there is a OSMV at fault 
Given user sets the entry/exit timer to "30" seconds
When user launches and logs in to the Lyric application
And user is set to "Home" mode through CHIL
When user navigates to "Security Solution Card" screen from the "Dashboard" screen
And user OSMV <Fault Type>
When user navigates to "Sensor Status" screen from the "Security Solution Card" screen
Then user should see the <Sensor Type> status as <Sensor Issue Type> on the "Sensor Status"
When user switches from "Home" to "Away"
Then user should receive a "Switch to Away" popup
...
When user navigates to "Sensor Status" screen from the "Security Solution Card" screen
Then user should see the <Sensor Type> status as <Sensor Issue Type> on the "Sensor Status"
Then user OSMV <Update Fault Type>

Examples:
|	Sensor Type		|	Fault Type			|	Sensor Issue Type		|	Off Status		|	Update Fault Type	|
|	OSMV	|	tampered				|	cover tampered			|	off				|	Tamper Restored		|
...
#Covered in 
#CommandControlWhenDoorSensorIsInFault, CommandControlWhenWindowSensorIsInFault, CommandControlWhenMotionSensorIsInFault, CommandControlWhenISMVIsInFault and CommandControlWhenISMVIsInFault #scenario
...
Scenario: As a user I should not be alarmed during exit delay time and motion sensor is in fault
Given user sets the entry/exit timer to "60" seconds
When user launches and logs in to the Lyric application
And user is set to "Home" mode through CHIL
When user navigates to "Security Solution Card" screen from the "Dashboard" screen
...
@CommandControlChangeInISMVStateDuringExitDelay		@UIAutomated
Scenario: As a user I should not be alarmed during exit delay time and ISMV is in fault
Given user sets the entry/exit timer to "60" seconds
When user launches and logs in to the Lyric application
And user is set to "Home" mode through CHIL
When user navigates to "Security Solution Card" screen from the "Dashboard" screen
...
Then user should be displayed with a "Switching to Night" text
And user should be displayed with a switching timer
When user "ISMV" detects the "Motion"
Then user should not be displayed with Alarm screen
And user status should be set to "Night"
Then user should be displayed with the correct time stamp
When user is set to "Home" mode through CHIL
...
@CommandControlChangeInOSMVStateDuringExitDelay		@UIAutomated
Scenario: As a user I should not be alarmed during exit delay time and OSMV is in fault
Given user sets the entry/exit timer to "60" seconds
When user launches and logs in to the Lyric application
And user is set to "Home" mode through CHIL
When user navigates to "Security Solution Card" screen from the "Dashboard" screen
...
Then user should be displayed with a "Switching to Night" text
And user should be displayed with a switching timer
When user "OSMV" detects the "Motion"
Then user should not be displayed with Alarm screen
And user status should be set to "Night"
Then user should be displayed with the correct time stamp
When user is set to "Home" mode through CHIL
...
And user "ISMV" detects the "Motion"
And user "OSMV" detects the "Motion"
And user switches from <Security Status> to "Away"
Then user should receive a "Switch to Away" popup
When user "dismisses" the "Switch to Away" popup
Then user status should be set to "Home" 
...
Examples: 
|	Security Status		|	Fault Type			|	Sensor Issue Type		|	Off Status		|
|	Home					|	opened				|	open						|	off				|
|	Off					|	opened				|	open						|	off				|