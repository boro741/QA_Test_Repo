...
#JasperNA
@AdhocOverrideGeofencebaseSchedulingChangemodeHeatcoolAutoOFFusing			@Automated		#TOBEDISCUSSED
...
#JasperNA
@AdhocOverridegeofencebaseschedulingdeletecurrentsleepperiodusing   		@InProgress		#TOBEDISCUSSED
