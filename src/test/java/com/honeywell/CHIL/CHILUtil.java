...
import com.ssts.util.reporting.result.TestCase;
...
public class CHILUtil implements AutoCloseable {
	...
	public int TriggerTimNextPeriod(long locationID, String deviceID,String CurrentPeriod, String Period ,String previousStartTime, String NextPeriodStartTime) {
		int result = -1;		
		try {
			if (isConnected) {
				String headerData = " ";
	...
	public int TriggerTimNextPeriod(long locationID, String deviceID,String PreviousPeriod,String CurrentPeriod, String NextPeriod ,String previousStartTime,String startTime, String NextPeriodStartTime) {
		int result = -1;		
		try {
			if (isConnected) {
				String headerData = " ";
