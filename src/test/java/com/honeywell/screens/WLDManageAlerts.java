...
public class WLDManageAlerts extends MobileScreens {
	...
	public String getIndoorTemperatureAlertsToggleValue() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			...
			WebElement toggleSwitch = testCase.getMobileDriver()
					.findElement(By.xpath("(//*[@name='AbnormalTemperature_toggle'])[1]"));
	...
	public String getIndoorHumidityAlertsToggleValue() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			...
			WebElement toggleSwitch = testCase.getMobileDriver()
					.findElement(By.xpath("(//*[@name='AbnormalHumidity_toggle'])[1]"));
			if (toggleSwitch.getAttribute("value").equals("1")) {
				return "ON";
			} else {
				return "OFF";
	...
	public boolean isEmailNotificationsforTemperatureAlertsTextVissible() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			return MobileUtils.isMobElementExists(objectDefinition, testCase,
					"EmailNotificationsforTemperatureAlertsText");
		} else {
			return MobileUtils.isMobElementExists(objectDefinition, testCase,
					"EmailNotificationsforTemperatureAlertsText");
		}
	...
	public boolean isEmailNotificationsforTemperatureAlertsToggleVissible() {
		return MobileUtils.isMobElementExists(objectDefinition, testCase,
				"EmailNotificationsforTemperatureAlertsToggle");
	}
	...
	public boolean isAlertforthisRangeTemperatureTextVissible() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			...
			WebElement range = testCase.getMobileDriver()
					.findElement(By.xpath("(//*[@value='Alert for this range'])[1]"));
	...
	public boolean isAlertforthisRangeTemperaturePercentageButtonVissible() {
		return MobileUtils.isMobElementExists(objectDefinition, testCase,
				"AlertforthisRangeTemperaturePercentageButton");
	}
	...
	public boolean isAlertforthisRangeHumidityTextVissible() {
		...
		int i = 0;
		while (!(MobileUtils.isMobElementExists(objectDefinition, testCase, "AlertforthisRangeHumidityText"))
				&& i < 10) {
	...
	public boolean verifyAlertforThisBelowTemperatureRangeUpdated(String belowTemp) {
		String str = MobileUtils.getFieldValue(objectDefinition, testCase,
				"AlertforthisRangeTemperaturePercentageButton");
	...
	public boolean isEmailNotificationsforTemperatureAlertsToggleEnabled() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			if (MobileUtils.getFieldValue(objectDefinition, testCase, "EmailNotificationsforTemperatureAlertsToggle")
					.equals("ON")) {
				flag = true;
			} else {
				flag = false;
			...
			try {
				WebElement toggleSwitch = testCase.getMobileDriver()
						.findElement(By.xpath("(//*[@name='AbnormalTemperature_toggle'])[2]"));
				if (toggleSwitch.getAttribute("value").equalsIgnoreCase("1")) {
					flag = true;
				} else {
					flag = false;
	...
	public boolean isEmailNotificationsforHumidityAlertsToggleEnabled() {
		if (testCase.getPlatform().toUpperCase().contains("ANDROID")) {
			if (MobileUtils.getFieldValue(objectDefinition, testCase, "EmailNotificationsforHumidityAlertsToggle")
					.equals("ON")) {
				flag = true;
			} else {
				flag = false;
			...
			try {
				WebElement toggleSwitch = testCase.getMobileDriver()
						.findElement(By.xpath("(//*[@name='AbnormalHumidity_toggle'])[2]"));
				if (toggleSwitch.getAttribute("value").equalsIgnoreCase("1")) {
					flag = true;
				} else {
					flag = false;
