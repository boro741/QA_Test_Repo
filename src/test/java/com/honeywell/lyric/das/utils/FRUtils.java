...
import org.mortbay.util.ajax.JSONPojoConvertor.Setter;
...
public class FRUtils {
	...
	public static boolean navigateToGlobalDrawerFromDashBoard(TestCases testCase) {
		...
		public static Boolean checkLocationPermittedForFR(TestCases testCase,TestCaseInputs inputs,Boolean isFRPermitted,long locationID){
						             ...
						             if(!tempJSON.isNull("devices")){
						            	    ...
						            	    if(!tempJSON.isNull("configuration"))
						            	    {
						            	       JSONObject tempJSON3=tempJSON.getJSONObject("configuration");
						            	    	 ...
						            	    	 {
						            	    		 JSONObject tempJSON2= tempJSON.getJSONObject("configuration").getJSONObject("faceRecognition");
						              ...
						              if(dasDeviceName.isEmpty()){
						            	  ...
						            	  {
						            		  Keyword.ReportStep_Pass(testCase, "No DAS Device Available in the given location and FR Disabled");
						            	  }
						            	  else{
		...
		public static Boolean IsDASDeviceAvailableAndRegistered(TestCases testCase,TestCaseInputs inputs,Boolean expectedBehaviour,long locationID){
			String html="";
		...
		public static void updateLocationThroughCHIL(TestCases testCase,TestCaseInputs inputs,String body,long locationID){
			try (CHILUtil chUtil = new CHILUtil(inputs)) {
