...
public class LoginToLyricWithUserWithoutAnyLocation extends Keyword {
	...
	public LoginToLyricWithUserWithoutAnyLocation(TestCases testCase, TestCaseInputs inputs) {
		this.inputs = inputs;
	...
	@Override
	@KeywordStep(gherkins = "^user launches and logs in to the Lyric application with user account without any location$")
	public boolean keywordSteps() {
		flag = flag & LyricUtils.launchAndLoginToApplicationWithUserWithoutAnyLocation(testCase, inputs);
		return flag;
	}
