...
public class LoginTheAppAfterSignOut extends Keyword {

	private TestCases testCase;
	private TestCaseInputs inputs;
	boolean success = false;

	public LoginTheAppAfterSignOut(TestCases testCase, TestCaseInputs inputs) {
		this.inputs = inputs;
	...
	@Override
	@KeywordStep(gherkins = "^user should be able to login to the app after sign out$")
	public boolean keywordSteps() {
		boolean flag = true;
		flag &= LyricUtils.loginToLyricApp(testCase, inputs);
		return flag;
	}
