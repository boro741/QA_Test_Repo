...
public class LoginToLyricWithoutClosingCoachMark extends Keyword {
	...
	public LoginToLyricWithoutClosingCoachMark(TestCases testCase, TestCaseInputs inputs) {
		this.inputs = inputs;
	...
	@Override
	@KeywordStep(gherkins = "^user launches and logs in to the Lyric application without closing coach mark$")
	public boolean keywordSteps() {
		flag = flag & LyricUtils.launchAndLoginToApplicationWithoutClosingCoachMark(testCase, inputs);
		return flag;
	}
