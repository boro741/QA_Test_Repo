...
public class SelectDeviceFromDashboard extends Keyword {
	...
	public boolean keywordSteps() {
		...
		else if(deviceType.get(0).equalsIgnoreCase("FlyCatcher device"))
		{
			deviceToBeSelected = inputs.getInputValue("LOCATION1_DEVICE1_NAME");
		}
		else if(deviceType.get(0).equalsIgnoreCase("Camera device"))
		{
			deviceToBeSelected = inputs.getInputValue("LOCATION1_DEVICE1_NAME");
		}
		else if(deviceType.get(0).equalsIgnoreCase("WLD device"))
		{
			deviceToBeSelected = inputs.getInputValue("LOCATION1_DEVICE1_NAME");
		}
