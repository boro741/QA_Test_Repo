...
public class DismissAlarmInVariousScreen extends Keyword {
	...
	public DismissAlarmInVariousScreen(TestCases testCase, TestCaseInputs inputs, DataTable screen) {
	...
	@Override
	@KeywordStep(gherkins = "^user can dismiss the alarm in following screen:$")
