...
public class NavigateFromEntryExitDelayInVariousScreen extends Keyword {
	...
	public NavigateFromEntryExitDelayInVariousScreen(TestCases testCase, TestCaseInputs inputs, DataTable screen) {
	...
	@Override
	@KeywordStep(gherkins = "^user can navigate from the entry exit delay in following screen:$")
