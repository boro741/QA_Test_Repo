...
public class VerifyTemperatureIntervalForEMEA extends Keyword {

	public TestCases testCase;
	public TestCaseInputs inputs;
	public boolean flag = true;

	public VerifyTemperatureIntervalForEMEA(TestCases testCase, TestCaseInputs inputs) {
	...
	@Override
	@KeywordStep(gherkins = "^verify temperature is incremental by 0.5C for celsius$")
