...
public class CreateDefaultTimeBasedScheduleThroughGeofence extends Keyword {
	...
	public CreateDefaultTimeBasedScheduleThroughGeofence(TestCases testCase, TestCaseInputs inputs,
	...
	@Override
	@KeywordStep(gherkins = "^user selects \"(.+)\" option while creating \"(.+)\" schedule with default schedule value$")
	public boolean keywordSteps() throws KeywordException {
		...
		String temp = " ";
		if (exampleData.get(0).equalsIgnoreCase("Confirm")) {
			inputs.setInputValueWithoutTarget("ConfirmTimeShedule", "true");
		} else {
