...
public class SetGeofenceSleepTime extends Keyword {
	...
	public SetGeofenceSleepTime(TestCases testCase, TestCaseInputs inputs,
			ArrayList<String> exampleData) {
	...
	public boolean keywordSteps() throws KeywordException {
		try {
			...
			if (!statInfo.isOnline()) {
				Keyword.ReportStep_Pass(testCase, "Set Sleep Time : Cannot set Sleep time because thermostat is offline");
				return true;
			}
