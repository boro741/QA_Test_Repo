...
public class EditButNotSavedGeofenceSchedule extends Keyword {
	...
	public EditButNotSavedGeofenceSchedule(TestCases testCase, TestCaseInputs inputs, ArrayList<String> exampleData) {
