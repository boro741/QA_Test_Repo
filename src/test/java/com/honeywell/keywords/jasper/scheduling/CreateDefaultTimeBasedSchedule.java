package com.honeywell.keywords.jasper.scheduling;
...
public class CreateDefaultTimeBasedSchedule extends Keyword {
	...
	public CreateDefaultTimeBasedSchedule(TestCases testCase, TestCaseInputs inputs, ArrayList<String> exampleData) {
	...
	@Override
	@KeywordStep(gherkins = "^user creates \"(.+)\" schedule with default schedule value$")
	public boolean keywordSteps() throws KeywordException {
		...
		if (exampleData.get(0).equalsIgnoreCase("Everyday")) {
			...
			inputs.setInputValue(InputVariables.UNITS, devInfo.getThermostatUnits());
			...
			inputs.setInputValue(InputVariables.EVERYDAY_4_TIME, defaultValues.get("EverydaySleepTime").toLowerCase());
			inputs.setInputValue(InputVariables.EVERYDAY_SLEEP_TIME, defaultValues.get("EverydaySleepTime").toLowerCase());
