...
public class VerifyTemperatureWithinRangeForEditedPeriodInTimeSchedule extends Keyword {

	public TestCases testCase;
	public TestCaseInputs inputs;
	public boolean flag = true;

	public VerifyTemperatureWithinRangeForEditedPeriodInTimeSchedule(TestCases testCase, TestCaseInputs inputs) {
	...
	@Override
	@KeywordStep(gherkins = "^verify edited period temperature is set within the maximum and minimum range$")
	public boolean keywordSteps() throws KeywordException {
		try {
			...
			if (statInfo.getThermostatType().equals("Jasper")) {
				flag = flag & JasperSchedulingVerifyUtils.verifyTemperatureWithinRangeForEditedPeriodInTimeSchedule(testCase, inputs,
