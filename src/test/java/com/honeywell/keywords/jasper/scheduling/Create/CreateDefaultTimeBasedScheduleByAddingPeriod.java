...
public class CreateDefaultTimeBasedScheduleByAddingPeriod extends Keyword {
	...
	public CreateDefaultTimeBasedScheduleByAddingPeriod(TestCases testCase, TestCaseInputs inputs,
